...
class Animal(models.Model):
    ...
    sexo_animal = models.ForeignKey(Sexo, verbose_name="Sexo", related_name="Sexo", on_delete=models.SET_NULL, null=True)
    nascimento_animal = models.DateField(verbose_name='Nascimento', default=None)
    raca_animal = models.ForeignKey(Raca, verbose_name="Raca", related_name="Raca", on_delete=models.SET_NULL, null=True)
    sangue_animal = models.ForeignKey(Sangue, verbose_name="Sangue", related_name="Sangue", on_delete=models.SET_NULL, null=True)  
    brincos_animal = models.CharField(verbose_name='Brincos', max_length=50)
    vida_animal = models.ForeignKey(Vida, verbose_name="Vida", related_name="Vida", on_delete=models.SET_NULL, null=True)
...
class Parto(models.Model):
    ...
    parto = models.ForeignKey(TipoParto, verbose_name="Tipo Parto", related_name="Parto", on_delete=models.SET_NULL, null=True)
...
class Medicacao(models.Model):
    ...
    medicacao = models.ForeignKey(TipoMedicacao, verbose_name="Tipo Medicacao", related_name="Medicacao", on_delete=models.SET_NULL, null=True)
